  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h1 class="display-1 text-white font-weight-bold font-primary">About</h1>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-10 mx-auto text-center">
        <h2>why do this?</h2>
        <p>I want to be friends with foreigners who visit Korea and just do volunteer work</p>
          ...
          <div class="slide">
            <div class="card text-center">
              <div class="card-body px-5 py-4">
                ...
                <h4 class="text-secondary">Host</h4>
                <p>“I want to help people who visit Korea. I'll take you from the airport to your accommodation and find the information you need.”</p>
              </div>
            </div>
          </div>
        </div>
...
<section class="section">
  ...
  <div class="row">
    <div class="col-lg-8 offset-lg-1">
      <h2 class="text-gradient-primary">Let's apply!</h2>
      <p class="h4 font-weight-bold text-white mb-4">If you have any questions, please send me an Instagram message</p>
      <a href="https://instagram.com/freepickupkr" target="_blank" class="btn btn-lg btn-primary">Let’s talk</a>
    </div>
  </div>
</div>
</section>
