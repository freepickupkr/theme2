...
<!-- page-title -->
<section class="page-title bg-cover" data-background="images/backgrounds/page-title2.jpg">
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h1 class="display-1 text-white font-weight-bold font-primary">My Services</h1>
      </div>
    </div>
  </div>
</section>
        ...
        <div class="card hover-bg-secondary shadow py-4">
          <div class="card-body text-center">
            <div class="position-relative">
              <i class="icon-lg icon-box bg-gradient-primary rounded-circle ti-car mb-5 d-inline-block text-white"></i>
              <i class="icon-lg icon-watermark text-white ti-car"></i>
            </div>
            <h4 class="mb-4">Pick up</h4>
            <p>Free airport pick-up service/drop off</p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-sm-6 mb-4">
        <div class="card hover-bg-secondary shadow py-4">
          <div class="card-body text-center">
            <div class="position-relative">
              <i class="icon-lg icon-box bg-gradient-primary rounded-circle ti-info mb-5 d-inline-block text-white"></i>
              <i class="icon-lg icon-watermark text-white ti-info"></i>
            </div>
            <h4 class="mb-4">Information</h4>
            <p>Information on various tourist information</p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-sm-6 mb-4">
        <div class="card hover-bg-secondary shadow py-4">
          <div class="card-body text-center">
            ...
            <h4 class="mb-4">Assistance</h4>
            <p>Help you with what you need</p>
          </div>
        </div>
      </div>
    </div>
